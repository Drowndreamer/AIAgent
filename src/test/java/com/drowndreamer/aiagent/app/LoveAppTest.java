...
class LoveAppTest {
    ...
    void doChatWithTools() {
        // 测试联网搜索问题的答案
        //testMessage("周末想带女朋友去上海约会，帮我搜索几个适合情侣的小众打卡地，然后推荐给我？");

        // 测试网页抓取：恋爱案例分析
        //testMessage("最近和对象吵架了，看看编程导航网站（codefather.cn）的其他情侣是怎么解决矛盾的？");

        // 测试资源下载：图片下载
        testMessage("下载一张适合做手机壁纸的情侣打闹的图片");

        // 测试终端操作：执行代码
        testMessage("执行 查看 Python 版本命令 python --version");
    ...
    void doChatWithMcp() {
        String chatId = UUID.randomUUID().toString();
        String message = "我的另一半在武汉理工大学马房山校区读书，请帮我找几家到附近10公里以内的合适的约会地点";
